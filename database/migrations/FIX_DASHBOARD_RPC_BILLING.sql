-- ==============================================================================
-- FIX DASHBOARD AGGREGATION RPC FOR NEW BILLING SCHEMA
-- Replaces references to legacy invoice columns (amount, issued_at)
-- with the new Enterprise Billing columns (grand_total, date)
-- ==============================================================================
...
BEGIN
    ...
    -- Active Projects (Only count truly active statuses and exclude archived)
